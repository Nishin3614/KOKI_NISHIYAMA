...
//
// ----------------------------------------
char CSound::m_pFilename[LABEL_MAX][36] = // ファイル名
{
	{ "data/BGM/BGM_TITLE_2.wav" },				// BGM_TITLE
	{ "data/BGM/BGM_GAME.wav" },				// BGM_GAME
	{ "data/BGM/BGM_RANKINGMODE.wav" },			// BGM_RANKING
	{ "data/SE/SE_ENTER.wav" },					// 決定音
	{ "data/SE/SE_FAIL.wav" },					// 失敗音
	{ "data/SE/SE_DOWN.wav" },					// 天井が落ちる音
	{ "data/SE/SE_THROW.wav" },					// 投げる時の音
	{ "data/SE/SE_DELETE.wav" },				// 消える時の音
