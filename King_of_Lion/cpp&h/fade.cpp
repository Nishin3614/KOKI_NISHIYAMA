...
//
// ------------------------------------------------------------------------------------------
#define	TEXTURE_FADE	"data/TEXTURE/ui/mozaiku.jpg"	// 読み込むテクスチャファイル名
...
void InitFade(MODE modeNext)
{
	...
	g_fade = FADE_OUT;
	g_modeNext = modeNext;
	g_colorFade = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f);	// 黒い画面（不透明）
...
void SetFade(MODE modeNext)
{
	g_fade = FADE_OUT;
	g_modeNext = modeNext;
	g_colorFade = D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.0f);	// 黒い画面（透明)
}
