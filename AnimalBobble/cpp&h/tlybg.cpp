...
//
// ----------------------------------------
#define TLYBG "data/hackdoll3.png"
...
// コンストラクタ処理
// ----------------------------------------
CTlyBg::CTlyBg() : CScene::CScene(ACTOR_BG, LAYER_OBJ)
{
	// 初期化
...
HRESULT CTlyBg::Load(void)
{
	...
	{
		{ "data/TEXTURE/BG/GameBG.png" },		// ゲーム用の背景
		{ "data/TEXTURE/BG/GameBG.png" },		// チュートリアル用の背景
		{ "data/TEXTURE/BG/TitleBG.jpg" },		// タイトル用の背景
		{ "data/TEXTURE/BG/GameBG.png" },		// 選択画面用の背景
		{ "data/TEXTURE/BG/GameBG.png" },		// リザルト用の背景
		{ "data/TEXTURE/BG/GameBG.png" },		// ランキング用の背景
	};
	// 位置情報代入
