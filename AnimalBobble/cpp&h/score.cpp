...
//
// ----------------------------------------
//CNumber * CScore::m_pNumber[MAX_SCORE] = {};	// スコア表示

// ----------------------------------------
// コンストラクタ処理
// ----------------------------------------
CScore::CScore() : CScene(ACTOR_SCORE,LAYER_OBJ)
{
	// スコア
	m_nScore = 0;
	// プレイヤー番号
...
// 作成処理
// ----------------------------------------
CScore * CScore::Create(CManager::PLAYER playerId, D3DXVECTOR3 pos)
{
	// 変数宣言
	CScore * pScore;
