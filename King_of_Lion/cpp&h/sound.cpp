...
SOUNDPARAM g_aParam[SOUND_LABEL_MAX] =
{
	...
	{"data/SE/SE_ENTER.wav", 0},					// 決定音
	{"data/SE/SE_ATTACK.wav", 0},					// ヒット音
	{"data/SE/SE_COLISION.wav", 0 },				// プレイヤが死んだ音(まだ)
	{"data/SE/SE_EAT.wav", 0},					// 猫缶音
	{"data/SE/SE_SHOT.wav", 0 },					// ダイヤモンド音
	{"data/SE/SE_BOSSVOICE.wav", 0 },				// 回復アイテム音
	{"data/SE/SE_RANKING.wav", 0},				// プレイヤが死んだ音(まだ)
};
