...
{
	{"data/BGM/BGM_TITLE.wav", -1},					// BGM_TITLE
	{"data/BGM/BGM_GAME.wav", -1},					// BGM_GAME
	{"data/BGM/BGM_GAMEOVER.wav", -1},				// BGM_GAMEOVER
	{"data/BGM/BGM_CLEAR.wav", -1},					// BGM_CLEAR
	{"data/BGM/BGM_RANKINGMODE.wav", -1},			// BGM_RANKING
	{"data/SE/SE_START.wav", 0},					// 決定音
	{"data/SE/SE_LOWKICK.wav", 0},					// ヒット音
	{"data/SE/SE_HIGHKICK.wav", 0 },				// プレイヤが死んだ音(まだ)
	{"data/SE/SE_CATFOOD.wav", 0},					// 猫缶音
	{"data/SE/SE_DIAMOND.wav", 0 },					// ダイヤモンド音
	{"data/SE/SE_CATRECOVERY.wav", 0 },				// 回復アイテム音
	{"data/SE/SE_CATDAMEGE.wav", 0},				// プレイヤが死んだ音(まだ)
	{"data/SE/SE_CATDIE.wav", 0 },					// プレイヤが死んだ音(まだ)
	{"data/SE/SE_BOSSLAST.wav", 0},					// ボスが倒された音
};
